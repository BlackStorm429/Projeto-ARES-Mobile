...
type NavProp = StackNavigationProp<RootStackParamList, 'FriendsModule'>;

export default function FriendsModuleScreen() {
  const route = useRoute<RouteProp<RootStackParamList, 'FriendsModule'>>();
    ...
    <View style={[styles.container, { backgroundColor: themeColors.background }] }>
      ...
      {moduleNumber === 1 ? (
        <WebView
          ...
          javaScriptEnabled
          domStorageEnabled
          source={{ uri: 'https://www.youtube.com/watch?v=nWsVBaZJxS4' }}
        />
      ) : (
