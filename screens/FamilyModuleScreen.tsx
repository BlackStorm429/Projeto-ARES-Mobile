...
type NavProp = StackNavigationProp<RootStackParamList, 'FamilyModule'>;

export default function FamilyModuleScreen() {
  const route = useRoute<RouteProp<RootStackParamList, 'FamilyModule'>>();
    ...
    <View style={[styles.container, { backgroundColor: themeColors.background }] }>
      ...
      {moduleNumber === 1 ? (
        <WebView
          ...
          javaScriptEnabled
          domStorageEnabled
          source={{ uri: 'https://www.youtube.com/watch?v=NewNXItpVaA' }}
        />
      ) : (
